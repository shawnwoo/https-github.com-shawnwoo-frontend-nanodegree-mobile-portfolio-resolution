...
/***
Refectored updatePositions to reduce the function calls and new Element created
1. Generate moving pizzas only based on the visible area when page loads.
2. Store the elements generated as a global variable instead of query it in every updatePositions calls.
3. Disable uncessary animation when scroll is not happening
**/
...
function updatePositions() {
  ...
  //move items out as a global variable instead of query it every time when updatePositions call
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  for (var i = 0; i < totalPizzaNumber; i++) {
